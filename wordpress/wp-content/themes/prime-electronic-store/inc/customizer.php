...
function prime_electronic_store_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'prime_electronic_store_sidebar_settings',
        array(
            'title' => esc_html__( 'Sidebar Settings', 'prime-electronic-store' ),
            'priority' => 20,
            'capability' => 'edit_theme_options',
        )
    );
    ...
    $wp_customize->add_control('prime_electronic_store_sidebar_text_align', array(
        'label'    => __('Sidebar Heading Text Align', 'prime-electronic-store'),
        'section'  => 'prime_electronic_store_sidebar_settings',
    ...
    $wp_customize->add_setting( 'prime_electronic_store_sidebar_position', array(
        'default'           => 'right',
        'sanitize_callback' => 'prime_electronic_store_sanitize_sidebar_position',
    ) );

    // Add Sidebar Position Control
    $wp_customize->add_control( 'prime_electronic_store_sidebar_position', array(
        'label'       => __( 'Sidebar Position', 'prime-electronic-store' ),
        'description' => __( 'Choose the position of the sidebar no sidebar option is not applicable for shop and product pages', 'prime-electronic-store' ),
        'section'     => 'prime_electronic_store_sidebar_settings',
        'type'        => 'radio',
        'choices'     => array(
            'left'  => __( 'Left Sidebar', 'prime-electronic-store' ),
            'right' => __( 'Right Sidebar', 'prime-electronic-store' ),
            'no-sidebar' => __( 'No Sidebar', 'prime-electronic-store' ),
        ),
    ) );
     /** Sidebar Settings for pages & Post End */
    ...
    $wp_customize->add_setting('prime_electronic_store_single_post_align',array(
        'default' => 'left-align',
        'sanitize_callback' => 'prime_electronic_store_sanitize_single_post_align'
    ));
    $wp_customize->add_control('prime_electronic_store_single_post_align',array(
        'type' => 'select',
        'label' => __('Post Content Alignment','prime-electronic-store'),
        'section' => 'prime_electronic_store_post_settings',
        'choices' => array(
            'left-align' => __('Left Alignment','prime-electronic-store'),
            'right-align' => __('Right Alignment','prime-electronic-store'),
            'center-align' => __('Center Alignment','prime-electronic-store'),
        ),
    ) );
