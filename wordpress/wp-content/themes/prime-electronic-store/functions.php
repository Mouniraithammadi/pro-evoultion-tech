...
if ( ! defined( 'PRIME_ELECTRONIC_STORE_BUNDLE_URL' ) ) {
    define( 'PRIME_ELECTRONIC_STORE_BUNDLE_URL', esc_url( 'https://www.themeignite.com/products/wp-theme-bundle', 'prime-electronic-store') );
}
...
function prime_electronic_store_scripts() {
	...
	wp_style_add_data('prime-electronic-store-style', 'rtl', 'replace');
...
function prime_electronic_store_body_sidebar_classes( $classes ) {
    $prime_electronic_store_sidebar_position = get_theme_mod( 'prime_electronic_store_sidebar_position', 'right' );

    if ( $prime_electronic_store_sidebar_position === 'left' ) {
        $classes[] = 'sidebar-left';
    } elseif ( $prime_electronic_store_sidebar_position === 'right' ) {
        $classes[] = 'sidebar-right';
    } elseif ( $prime_electronic_store_sidebar_position === 'no-sidebar' ) {
        $classes[] = 'no-sidebar';
    }

    return $classes;
}
add_filter( 'body_class', 'prime_electronic_store_body_sidebar_classes' );